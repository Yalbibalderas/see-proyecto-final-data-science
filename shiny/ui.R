...
shinyUI(navbarPage(
  theme = shinytheme("cerulean"), #cerulean es el Fondo de la pantalla
  # titulo de la App  ----
  "ARQUIMEDEZ",
  ...
  tabPanel(
    ...
    sidebarLayout(
      ...
      sidebarPanel(
        h4("Equipo de científicos de datos"),

        img(
          src = 'https://553801.smushcdn.com/1938437/wp-content/uploads/2020/08/Jaime_Soria_Viteri-400x-300x400.jpg?lossy=1&strip=1&webp=1',
          height = 100,
          width = 75
        ),
        p("Dr. Jaime Soria"),
        img(
          src = 'https://pbs.twimg.com/profile_images/1010320061192552450/Kw7s7nTu_400x400.jpg',
          height = 100,
          width = 75
        ),
      ...
      mainPanel(
        ...
        p(
          "Cuando un paciente es trasladado a la Unidad de Cuidados Intensivos (UCI) 
      ...
      resultados de laboratorio y comorbilidades para predecir su probabilidad de mortalidad."
        ...
        br(),
        p(
          "Con esto en mente, se usó la base de datos del Datathon 2020 disponible en Kaggle, y se desarrollo una applicación 
      ...
      su mortalidad."
        ...
        fluidRow(
          ...
          column(2, numericInput("age", label = h4("Edad"), value = 65)),
          ...
          column(
            ...
            radioButtons(
              "ethnicity",
              label = h4("Escoja etnia del paciente:"),
              choices = list(
                "Hispano" = "Hispanic",
                "Caucasico" = "Caucasian",
        ...
        fluidRow(
          h3("Características hospitalarias"),
          column(
            3,
            radioButtons(
              "icu_admit_source",
              label = h4("Procedencia de la admisión:"),
              choices = list(
                "Área de Emergencia" = "Accident & Emergency",
                "Piso" = "Floor",
          ...
          column(
            ...
            radioButtons(
              "icu_type",
              label = h4("Tipo de atención en UCI:"),
              choices = list(
                "CTICU" = "CTICU",
          ...
          column(
            ...
            numericInput(
              "pre_icu_los_days",
              label = h4(
                "Ingrese días de hospitalizacion previo al traslado a UCI"
              ),
              value = 0
            )
          ),
        ...
        fluidRow(
          ...
          column(
            3,
            numericInput("glucose_apache", label = h4("Glucosa"), value = 134)
          ),
          column(3, numericInput("bun_apache", label = h4("Urea"), value = 19)),
          column(
            3,
            numericInput(
              "creatinine_apache",
          ...
          column(
            3,
            numericInput("sodium_apache", label = h4("Sodio"), value = 138)
          ),
          column(
            3,
            numericInput("albumin_apache", label = h4("Albumina"), value = 2.9)
          ),
          column(
            3,
            numericInput(
        ...
        fluidRow(
          h3("Situaciones especiales"),
          column(
            4,
            radioButtons(
              "elective_surgery",
              label = h4("Cirugía electiva"),
              choices = list("Si" = "Si", "No" = "No", "Desconocido" = "No"),
              selected = "No"
            )
          ),
        ...
        fluidRow(
          ...
          column(
            ...
            radioButtons(
              "gcs_eyes_apache",
              label = h4("Respuesta ocular"),
              choices = list(
                "Espontáneamente abiertos" = 4,
  ...
  navbarMenu(
    "Análisis exploratorio", # sirve para generar varias pestañas en una sola
    tabPanel(
      "Análisis univariado",
      ...
      p(
        "A continuacion presentamos de forma dinamica el analisis estadistico 
      ...
      numericInput(
        ...
        value = 5
      ), # en que valor aparecerá al comienzo

      strong(
        "Se presenta la tabla con las caracteristicas descriptivas de la variable:"
      ),
