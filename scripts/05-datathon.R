# =============================================================================
# 05 — Script exploratorio inicial (Datathon)
# Proyecto: Predicción de mortalidad en UCI (WiDS Datathon 2020)
# Autores: Yalbi Balderas, Jaime Soria, Belén Escola
# Descripción: Script exploratorio inicial con regresión logística simple
#              y análisis descriptivo preliminar de las variables.
# =============================================================================
...
# NOTA: attach() generalmente no se recomienda en R moderno, pero se conserva
# por compatibilidad con este script legacy.
...
mortalidad_Model1 = glm(
  formula = hospital_death ~ age,
  data = data,
  family = binomial()
)

mortalidad_Model2 = glm(
  formula = hospital_death ~ age + elective_surgery,
  data = data,
  family = binomial()
)
