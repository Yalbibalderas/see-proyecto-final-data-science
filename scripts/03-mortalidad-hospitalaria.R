# =============================================================================
# 03 — Análisis de mortalidad hospitalaria
# Proyecto: Predicción de mortalidad en UCI (WiDS Datathon 2020)
# Autores: Yalbi Balderas, Jaime Soria, Belén Escola
# Descripción: Análisis de la correlación entre mortalidad hospitalaria
#              observada y la predicción del score APACHE 4a por hospital.
# =============================================================================
...
Mortalidad_hospitalaria <- fpe %>%
  ...
  pivot_wider(names_from = hospital_death, values_from = Cant_sobrevivio)
...
Mortalidad_hospitalaria_apache_4a <- merge(
  x = Mortalidad_hospitalaria,
  y = Apache_mortalidad,
  by.x = "hospital_id",
  by.y = "hospital_id"
)
...
Mortalidad_hospitalaria_apache_4a <- filter(
  Mortalidad_hospitalaria_apache_4a,
  Sobrevivió >= 25
)

# Existe correlacion entre la probabilidad de fallcer y el reisgo de fallecer medido por APACHE 4a en los diferentes hospitales
# si existe esta correlacion y es de un r= 68
pairs.panels(Mortalidad_hospitalaria_apache_4a)

plot(
  Mortalidad_hospitalaria_apache_4a$porcentaje_mortalidad,
  Mortalidad_hospitalaria_apache_4a$Mediana_Apache_4a
)
